...
public class MyWebServerSimple implements MyWebServer {
    ...
    public MyWebServerSimple(int port, ClientService clientService, Gson gson, TemplateProcessor templateProcessor) {
